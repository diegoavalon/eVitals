  ...
  pages: [
    {
      ...
      results: {
        mobile: {
          ...
          metrics: { lcp: 1500, cls: 0.05, tbt: 50 },
        ...
        desktop: {
          ...
          metrics: { lcp: 3000, cls: 0.1, tbt: 300 },
    ...
    },
    {
      ...
      results: {
        mobile: {
          ...
          metrics: { lcp: 1800, cls: 0.06, tbt: 100 },
        ...
        desktop: {
          ...
          metrics: { lcp: 5000, cls: 0.3, tbt: 900 },
    ...
    },
    {
      ...
      results: {
        mobile: {
          ...
          metrics: { lcp: 1700, cls: 0.05, tbt: 80 },
    ...
    },
    {
      ...
      results: {
        mobile: {
          ...
          metrics: { lcp: 1600, cls: 0.06, tbt: 90 },
        ...
        desktop: {
          ...
          metrics: { lcp: 4500, cls: 0.2, tbt: 650 },
